        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3 pb-2">
            <button
              ...
              className="w-full bg-[#0073e6] text-white font-bold text-[15px] py-4 rounded-full active:scale-[0.98] transition-transform cursor-pointer"
            >
              Não, quero continuar
            </button>
            <button
              ...
              className="w-full bg-[#F3F6FA] text-[#0073e6] font-bold text-[15px] py-4 rounded-full active:scale-[0.98] transition-transform cursor-pointer"
            >
              Sim, cancelar
            </button>
          </div>
