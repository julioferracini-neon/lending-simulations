        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="w-full bg-[#0073ea] hover:bg-[#0062c4] active:scale-[0.98] text-white font-bold py-3.5 rounded-full transition-all text-[15px]"
            >
            ...
            <button
              ...
              className="w-full bg-transparent hover:bg-slate-100 text-[#0073ea] font-bold py-3.5 rounded-full transition-all text-[15px]"
            >
      ...
      >
        <div className="flex flex-col mb-4">
          ...
          <button
            ...
            className="w-full mt-6 bg-[#0073ea] hover:bg-[#0062c4] active:scale-[0.98] text-white font-bold py-3.5 rounded-full transition-all text-[15px]"
          >
            Entendi
          </button>
        </div>
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="w-full mt-2 bg-[#0073ea] hover:bg-[#0062c4] active:scale-[0.98] text-white font-bold py-3.5 rounded-full transition-all text-[15px]"
          >
            Entendi
          </button>
        </div>
